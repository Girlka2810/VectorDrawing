...
namespace VectorDrawin.Tests.FiguresTests
{
    public class TriangleFigureTests
    {
        ...
        public void GetPointsNegativeTests(int parametersNumber)
        {
            ...
            {
                new TriangleFigure().Get(ActualParametrsOfTriangleFigureMock(parametersNumber));
            });
        }
        ...
        PointF[] ExpectedPointsOfTriangleFigureMock(int n)
        {
            ...
            {
                case 1:
                    return new [] {new PointF(1, 2), new PointF(3, 4),  new PointF(0,0),};
                case 2:
                    return new [] {new PointF(3, 4), new PointF(3,3), new PointF(1, 2)};
                case 3:
